            ...
            <div class="col-md-12 bg-primary py-4 text-center d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <?php else: ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" style="max-height: 200px; overflow-y: auto;">
                            <a class="dropdown-item <?php echo e($key == 'login' ? 'active' : ''); ?>" href="/">Login</a>
                            <a class="dropdown-item <?php echo e($key == 'register' ? 'active' : ''); ?>" href="/register">Register</a>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <!-- Home link -->
                            <a class="nav-link <?php echo e($key == 'home' ? 'active' : ''); ?>" id="v-pills-home-tab"
                                href="/home">Home</a>
                            <!-- Profile link -->
                            <a class="nav-link <?php echo e($key == 'masterdata' ? 'active' : ''); ?>" id="v-pills-movies-tab"
                                href="/masterdata">Master Data</a>
                            <!-- Messages link -->
                            <a class="nav-link <?php echo e($key == 'about' ? 'active' : ''); ?>" id="v-pills-messages-tab"
                                href="/about">About</a>
                            <!-- Settings link -->
                            <a class="nav-link <?php echo e($key == 'faq' ? 'active' : ''); ?>" id="v-pills-settings-tab"
                                href="/faq">FAQ</a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\ACER\silk_road_project\resources\views/layout/main.blade.php ENDPATH**/ ?>